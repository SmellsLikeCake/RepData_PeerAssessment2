...
Firstly, I load the packages I may need.
...
Then the data is loaded. I then run a command to get a sense of the size and format of the data.
...
There are several variables which are factors which would be better categorised as something else. I process these first.
